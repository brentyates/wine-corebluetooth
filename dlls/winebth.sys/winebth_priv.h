...
{
    UINT32 props_mask; /* UINT32 for 8-byte alignment */
    UINT32 padding;
...
union winebluetooth_watcher_event_data
{
    ...
    winebluetooth_gatt_characteristic_t gatt_characteristic_removed;
};
